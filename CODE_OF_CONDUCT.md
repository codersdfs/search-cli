...
the ghfind community a harassment-free experience for everyone,
...
repository, issues, pull requests, and Discussions) and also applies
...
be reported to the maintainer via GitHub's
[private contact form](https://github.com/codersdfs) or through
[private security contact](https://github.com/codersdfs/search-cli/security/advisories/new)
